...
#import "FPSWeakProxy.h"

#define kSize CGSizeMake(55, 20)

@implementation FPSShowLabel
{
    CADisplayLink *_link;
    NSUInteger _count;
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    self.backgroundColor = [UIColor colorWithRed:54/255.f green:179/255.f blue:243/255.f alpha:0.8f];
    ...
    _link = [CADisplayLink displayLinkWithTarget:[FPSWeakProxy proxyWithTarget:self] selector:@selector(tick:)];
